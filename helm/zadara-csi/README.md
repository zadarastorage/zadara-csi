...
## Zadara-CSI: Persistent storage for Kubernetes

Zadara-CSI is a Container Storage Interface (CSI) Kubernetes plugin with support for Block (iSCSI) and NAS (NFS) volumes. 
